...
describe('omx doctor model context recommendation warning', () => {
  it('warns when gpt-5.6-terra model_context_window exceeds the OMX setup recommendation', async () => {
    await withConfig(
      `
model = "gpt-5.6-terra"
...
`,
  ...
  it('warns when gpt-5.6-terra model_auto_compact_token_limit exceeds the OMX setup recommendation', async () => {
    await withConfig(
      `
model = "gpt-5.6-terra"
...
`,
  ...
  it('warns with both oversized gpt-5.6-terra context settings in the same message', async () => {
    await withConfig(
      `
model = "gpt-5.6-terra"
model_context_window = 1000000
...
`,
  ...
  it('does not warn when gpt-5.6-terra context settings match the OMX setup recommendation', async () => {
    await withConfig(
      `
model = "gpt-5.6-terra"
model_context_window = 250000
