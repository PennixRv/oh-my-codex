...
> **[官方網站](https://github.com/PennixRv/oh-my-codex)** | **[說明文件](../index.html)** | **[CLI 參考手冊](../index.html#cli-reference)** | **[工作流程](../index.html#workflows)** | **[OpenClaw 整合指南](../openclaw-integration.zh-TW.md)** | **[GitHub](https://github.com/PennixRv/oh-my-codex)** | **[npm](https://www.npmjs.com/package/oh-my-codex-pennix)**
...
- `config.toml` 更新（兩種範圍均適用）：
  - `notify = ["node", "..."]`
  - 根層 `model_reasoning_effort` 保持為使用者自主管理；如需設定請顯式使用 `omx reasoning ...` 或啟動參數
...
- **[完整說明文件](../index.html)** — 完整指南
- **[CLI 參考手冊](../index.html#cli-reference)** — 所有 `omx` 指令、旗標與工具
- **[通知設定指南](../index.html#notifications)** — Discord、Telegram、Slack 及 Webhook 設定
- **[推薦工作流程](../index.html#workflows)** — 實戰驗證的技能鏈，適用常見任務
- **[版本發行說明](../index.html#release-notes)** — 每個版本的新功能
