...
> **[Website](https://github.com/PennixRv/oh-my-codex)** | **[Documentation](../index.html)** | **[CLI Reference](../index.html#cli-reference)** | **[Workflows](../index.html#workflows)** | **[Guide d’intégration OpenClaw](../openclaw-integration.fr.md)** | **[GitHub](https://github.com/PennixRv/oh-my-codex)** | **[npm](https://www.npmjs.com/package/oh-my-codex-pennix)**
...
- Mises à jour de `config.toml` (pour les deux scopes) :
  - `notify = ["node", "..."]`
  - la clé racine `model_reasoning_effort` reste gérée par l'utilisateur ; définissez-la explicitement via `omx reasoning ...` ou des flags de lancement si besoin
...
- **[Documentation complète](../index.html)** — Guide complet
- **[Référence CLI](../index.html#cli-reference)** — Toutes les commandes `omx`, flags et outils
- **[Guide des notifications](../index.html#notifications)** — Configuration Discord, Telegram, Slack et webhooks
- **[Workflows recommandés](../index.html#workflows)** — Chaînes de skills éprouvées pour les tâches courantes
- **[Notes de version](../index.html#release-notes)** — Nouveautés de chaque version
