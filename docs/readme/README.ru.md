...
> **[Website](https://github.com/PennixRv/oh-my-codex)** | **[Documentation](../index.html)** | **[CLI Reference](../index.html#cli-reference)** | **[Workflows](../index.html#workflows)** | **[Руководство по интеграции OpenClaw](../openclaw-integration.ru.md)** | **[GitHub](https://github.com/PennixRv/oh-my-codex)** | **[npm](https://www.npmjs.com/package/oh-my-codex-pennix)**
...
- Обновления `config.toml` (для обеих областей):
  - `notify = ["node", "..."]`
  - root `model_reasoning_effort` остаётся под управлением пользователя; настройте его сами через `omx reasoning ...` или launch-флаги при необходимости
...
- **[Полная документация](../index.html)** — Полное руководство
- **[Справочник CLI](../index.html#cli-reference)** — Все команды `omx`, флаги и инструменты
- **[Руководство по уведомлениям](../index.html#notifications)** — Настройка Discord, Telegram, Slack и webhook
- **[Рекомендуемые рабочие процессы](../index.html#workflows)** — Проверенные в бою цепочки навыков для типичных задач
- **[Примечания к выпускам](../index.html#release-notes)** — Что нового в каждой версии
