...
- [x] `npm pack --dry-run`
- [x] `git diff --check`
- [x] `node dist/scripts/generate-release-body.js --template RELEASE_BODY.md --out /tmp/RELEASE_BODY.v0.18.63.generated.md --current-tag v0.18.63 --previous-tag v0.18.62 --repo PennixRv/oh-my-codex`
